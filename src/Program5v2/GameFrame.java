...
public class GameFrame extends JFrame {
    ...
    private JLabel lbl = new JLabel("Score: " + game.getScore() + "                                     Highscore: " + highscore);
    ...
    private class Clock implements ActionListener{
        public void actionPerformed(ActionEvent e) {
            ...
            lbl.setText("Score: " + game.getScore() + "                                     Highscore: " + highscore);// get the score from the game
            if(!game.keepPlaying()){ // if the game is over, stop the time and display a message
                btn.setText("Reset");
                lbl.setText("Score: " + game.getScore() + " Please Try again and press the reset button! The highscore was " + highscore);
                timer.stop();
            }
    ...
    private class ButtonListener implements ActionListener{
        public void actionPerformed(ActionEvent e) {
            if(btn.getText().equals("Start")){
                ...
                btn.setText("Start");
                game.init();
                lbl.setText("Score: " + game.getScore() + "                                     Highscore: " + highscore);
                gp.repaint();
            }
